...
#ifndef __PRN_INCLUDED__   // if x.h hasn't been included yet...
#define __PRN_INCLUDED__   //   #define this so the compiler knows it has been included
...
public:
	Printnode::Printnode(scene::ISceneNode* parent, scene::ISceneManager* mgr, s32 id,core::vector3df Start, core::vector3df End,core::vector3df Up,float Width, float Height)
